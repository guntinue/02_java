...
public class Application1 {
    public static void main(String[] args) {
        ...
        Consumer<String> consumer2 = (String s) -> System.out.println(s+"이(가) 입력됨");
        ...
        biConsumer.accept("hi", LocalTime.now());

        /*IntConsumer#accept(int value): void ==> int값을 받아 소비한다. */
        IntConsumer intConsumer = (int num) -> System.out.println("입력하신 정수의 제곱은 : "+
                (num*num)+"입니다.");
