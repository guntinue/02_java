...
public class Application3 {
    public static void main(String[] args) {
        ...
        String emp1 = "100/김철수/서울/영업부";
        String emp2 = "200/김영희//총무부";
        String emp3 = "300/김유리/경기도/";

        String[] split = emp1.split("/");
        String[] split2 = emp2.split("/");
        String[] split3 = emp3.split("/");
        System.out.println(Arrays.toString(split));
        System.out.println(Arrays.toString(split2));
        System.out.println(Arrays.toString(split3));

        System.out.println("==========================");
        // 음수를 마지막 인자로 넣어주게 되면 마지막 구분자 뒤의 값이 존재하지 않는 경우 빈 문자열로 토큰 생성
        String[] emp4 = emp3.split("/",-1);
        System.out.println(Arrays.toString(emp4));

        String[] emp5 = emp1.split("/",3);
        System.out.println(Arrays.toString(emp5));
        ...
        while(st1.hasMoreTokens()) { // hasMoreTokens)( : 현재 개발 토큰이 있는지 없는지 체크
        ...
        // StringTokenize의 두번째 인자 문자열 자체는 연속된 문자열이 아닌 각각을 구분자로 이용하겠다는 의미
        StringTokenizer colorStringTokenizer = new StringTokenizer(colorStr, "*/ #");
        while(colorStringTokenizer.hasMoreTokens()) {
            System.out.println("colorStr : " + colorStringTokenizer.nextToken());
        }
    }
}
