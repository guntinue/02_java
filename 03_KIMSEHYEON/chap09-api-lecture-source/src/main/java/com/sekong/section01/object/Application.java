package com.sekong.section01.object;

import com.sekong.section01.object.book.Book;
...
public class Application {
    public static void main(String[] args) {
        ...
        * 인스턴스가 생성될 때 사용한 full class name과 0 그리고 16진수 해쉬코드가 문자열로 반환
        * 동일한 값을 가지는 인스턴스도 다른 해쉬코드를 가진다.*/
