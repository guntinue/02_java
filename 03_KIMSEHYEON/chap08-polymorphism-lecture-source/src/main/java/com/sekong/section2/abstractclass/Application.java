...
public class Application {
    public static void main(String[] args) {
        ...
        * 추상클래스를 사용하려면 추상클래스를 상속받는 하위 클래스를
        * 이용해서 인스턴스를 생성해야한다.
        * 이 때 추상클래스는 상위 타입으로 사용될 수 있으며 다형성을 이용할 수 있다.
        *
        * 추상클래스에 작성한 추상메소드는 반드시 후순이 오버라이딩해서 작성해야하며,
        * 후손 클래스들의 메소드들의 공통 인터페이스로의 역할을 수행할 수 있다.
        * 추상클래스에 작성한 메소드를 호출하게 되면 설계 후손 타입의 인스턴스가 가지는
        * 메소드로는 다형성이 적용되며 동적 바인딩에 의해 다양한 응답을 할 수 있게 한다.
        *
        ...
        * 추상메소드의 경우 반드시 abstract키워드를 메소드 헤드에 작성해야한다.
...
//        Product product = new Product();
        ...
        /* 다형성을 적용해서 추상클래스를 레퍼런스 타입으로 사용할 수 있다.*/Product product = new Smartphone();
        product.abstMethod(); // 정적 바인딩 -> Product, 동적바인딩 -> Smartphone
