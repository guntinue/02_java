...
public class ExamClass {
    public static void main(String[] args) {
        //경로 : src/main/java/com/sekong/section01/logs/app
        String basePath = "src/main/java/com/sekong/section01/logs/app";
        // 생성 경로에 오늘 날짜로 파일을 생성하고
        // 해당파일을 열어서 아무 글자가 입력
        ...
        //src/main/java/com/sekong/section01/logs/app/20251030.txt
        File todayFile = new File("src/main/java/com/sekong/section01/logs/app/20251030.txt");
        try {
