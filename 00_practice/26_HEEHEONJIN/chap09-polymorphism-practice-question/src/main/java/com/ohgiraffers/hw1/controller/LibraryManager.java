package main.java.com.ohgiraffers.hw1.controller;

import main.java.com.ohgiraffers.hw1.model.dto.AniBook;
import main.java.com.ohgiraffers.hw1.model.dto.Book;
import main.java.com.ohgiraffers.hw1.model.dto.CookBook;
...
public class LibraryManager {
    ...
    public Book[] searchBook(String keyword) {
        ...
        for (int i = 0; i < books.length; i++) {
            if(keyword.contains(books[i].getTitle())){
                books[i] = books[i];
                count++;
            }
        }
