package com.sekong.hw1.controller;

import com.sekong.hw1.model.dto.AniBook;
import com.sekong.hw1.model.dto.Book;
import com.sekong.hw1.model.dto.CookBook;
...
public class LibraryManager {
    ...
    public int rentBook(int index){
        ...
        if(bList[index] instanceof AniBook && (myInfo().getAge() < ((AniBook) bList[index]).getAccessAge())){
            result = 1;
