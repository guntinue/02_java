...
public class Application2 {
    public static void main(String[] args) {
        ...
        * 기본 용량을 초과하는 경우 (기본 문자열 + 1) * 2 를 하여 용량을 확장한다.
        * */
        ...
        StringBuffer sb2 = new StringBuffer("javamysal");
        ...
        * */
        ...
        System.out.println("delete() : " + sb2.delete(2,5)); // javamysql -> kjaysq;
        ...
        * */
        ...
        System.out.println("insert() : " + sb2.insert(sb2.length(),"~~Helloworld"));
