...
public class Application1 {
    public static void main(String[] args) {
        ...
        /*
        * charAt(int) : 해당 문자열의 특정 인덱스에 해당하는 문자를 반환한다.
        ...
        *  */
        ...
        for (int i = 0; i < str1.length(); i++) {
            System.out.print("charAt(" + i + ") " + str1.charAt(i));
        }
        ...
        * */
        ...
        /*
        * concat() : 문자열에 인자로 전달괸 문자열을 합치기해서 새로운 문자열을 반환한다.
        * 원본 문자열에는 영향을 주지 않는다.
        * */
        ...
        * */
        ...
        /*trim() : 문자열의 아ㅠ 뒤에 공백을 제거한 문자열을 반환한다.*/
        String trimStr = "       java         ";
        ...
        /*
        * toLowerCase(): 모든 문자를 소뭄ㄴ자로 변환시킨다.
        * toUpperCase(): 모든 문자를 대소문자로 변환시킨다. */

        String caseStr = "javaMariadb";
        System.out.println("caseStr : " + caseStr.toLowerCase());
        System.out.println("caseStr : " + caseStr.toUpperCase());

        /*
        * substring() : 문자열의 일부를 잘라내어 새로운 문자열을 반환한다.
        * */

        String javamysal = "javamysal";
        System.out.println("substring(3, 6) : " + javamysal.substring(3, 6));
        System.out.println("substring(3) : " + javamysal.substring(3, 6));
        System.out.println("substring(3) : " + javamysal.substring(3));
        System.out.println("javamysql : " + javamysal);
