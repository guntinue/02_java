...
public class Application {
    public static void main(String[] args) {
        ...
        *
        * Rabbit은 Rabbit타입이기도 하면서 Animal 타입이기도 하다.
        ...
        * */
        ...
        /*Animal은 Animal 타입이지 Tiger이지 Rabbit이 아니다.*/

        System.out.println(" 동적 바인드 ===============================");
        animal1.cry(); // 자식꺼가 우선되어 먼저 나온다.
        animal2.cry(); // . 직으면 참조 연산자

        /*
        * 객체별로 고유한 기능을 동작시키기 위해서는 레퍼런스 변수를 형변환하여 Rabbit 과 Tiger로
        * 변경해야 메소드 호출이 가능하다.
        ...
        * */
        ...
        /*
        * instanceof 연산자 이용
        * 레퍼런스변수가 참조하는 실제 인스턴스가 원하는 타입과 맞는지 비요하는 연산자
        * */
