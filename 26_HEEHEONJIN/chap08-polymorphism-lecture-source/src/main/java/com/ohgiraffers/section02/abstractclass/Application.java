...
public class Application {
    public static void main(String[] args) {
        ...
        * 추상 클래스는ㄴ 클래스 선언부에 abstract 키워드를 명시해야한다.
        * 추상클래스로는 인ㄴ스턴스 생성할 수 없다.
        * 추상클래스를 사용하려면 추상클래스를 상속받는 하위 클래스를ㄹ
        * 이용해서 인스턴스를 생성해야 한다.
        ...
        *
         ...
         * 메소드로는 다형성이 적용되어 동적바인딩에 의해 다양한 응답을 할 수 있게 된다.
         *
        ...
        * */
        ...
        /* 다형성을 적용해서 추상클래스를 레퍼런스 타입으로 사용할 수 있다. */
        Product product = new SmartPhone();
        /* 정적 바인딩 -> Product, 동적바인딩 -> SmartPhone */
        product.abstMethod();
