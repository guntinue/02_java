...
public class Application {
    public static void main(String[] args) {
        ...
        Consumer<String> consumer =  s -> System.out.println(s + "가 입력됨");
        ...
        /* LongConsumer#accept(long value):void ==> Long 값을 받아 소비한다 */
//        LongConsumer longConsumer = (long num) -> System.out.println("입력하신 정수는 "  + num + "입니다. ");
        ...
        ObjIntConsumer<java.util.Random> objIntConsumer = (random, bound) ->
                System.out.println("0부터 " + bound + "전까지 난수 발생 :" + random.nextInt(bound));
        ...
        objLongConsumer.accept(LocalDate.now(), 40);
        ...
        objDoubleConsumer.accept(new StringBuilder("절대값 : "), -123.4);
