package com.ohgiraffers.section02.uses.subseciton01.generation;
...
public class Application2 {
    public static void main(String[] args) {
        ...
        IntStream helloworldChars = "heloow world".chars();
        helloworldChars.forEach(i -> System.out.print((char) i + " "));
        System.out.println();
...
//        stringStream2.forEach(i -> System.out.print(i + " "));
        ...
        * 재사용할 수 없다. 재사용하면 java.lang.IllegalStateException이 발생한다.
        * */
//        stringStream2.forEach(i -> System.out.print(i + " "));
        /* concat()을 통해 스트림 합치기 */
