...
public class Application1 {
    public static void main(String[] args) {
        ...
        /* Consumer<T>#accpt(T t) : 객체 T를 받아 소비 */
        ...
        /* IntConsumer#accept(int value) : void ==> int값을 받아 소비 */
        ...
        /* ObjIntConsumer#accept(T t, int value) : void ===> 객체 T와 int 값을 받아서 소비 */
        ...
        /* ObjLongConsumer#accept(T t, long value) : void ==> 객체 t와 long값을 받아 소비 */
        ...
        /* ObjDoubleConsumer#accept(T t, double value) : void ==> 객체 t와 double값을 받아 소비 */
