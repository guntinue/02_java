...
public class Application4 {
    ...
    public static void main(String[] args) {
        ...
        boolean anyMatch = stringList.stream().anyMatch(str -> str.contains("ring"));
        boolean allMatch = stringList.stream().allMatch(str -> str.contains("ring"));
        boolean noneMatch = stringList.stream().noneMatch(str -> str.contains("ring"));
