...
import com.ohgiraffers.section02.enumtype.FoodsEnum.MEAL;
...
//        enumTest(0, 0)
        ...
        FoodsEnum.MEAL mealAnButterKimchiStew = MEAL.MEAL_AN_BUTTER_KIMCHI_STEW;
        System.out.println("mealAnButterKimchiStew = " + mealAnButterKimchiStew);


        /*
        * 4. 필요하다면 필드나 메소드를 추가할 수 있다.
        * 단, 근본적으로 불변객체이기 때문에 모든 필드는 final로
        * 선언되어야한다.
