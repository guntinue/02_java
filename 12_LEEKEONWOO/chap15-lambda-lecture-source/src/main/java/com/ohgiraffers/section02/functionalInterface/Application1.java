...
//        Runnalble runnalble = () -> System.out.println("Hello2");
//        runnalble.run();
        ...
        IntConsumer intConsumer = num -> System.out.println("입력하신 정수의 제곱은 : " +
                (num * num) + " 입니다.");
        ...
        /* ObjIntConsumer#accept(T t, U u) : void ==> 객체 T와 int값을 받아 소비한다. */
        /* java.lang.Math.random() static메소드 */
        /* java.util.Random > nextLine */
        ObjIntConsumer<java.util.Random> objIntConsumer = (random, bound) ->
                System.out.println("0부터 " + bound + "전까지의 난수 발행 : " + random.nextInt(bound));
